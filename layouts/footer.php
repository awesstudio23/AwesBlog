            ...
            <div class="col-auto">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link text-lg text-muted">
                            <figure>
                                <svg width="1em" height="1em" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="facebook" class="svg-inline--fa fa-facebook fa-w-16" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
